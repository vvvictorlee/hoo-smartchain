...
func TestCheckConfigForkOrder(t *testing.T) {
	...
	tests := []test{
		...
		{new: TestChainConfig},
		{new: &ChainConfig{MoonBlock: big.NewInt(0)}, isErr: true},
		{new: &ChainConfig{MoonBlock: big.NewInt(1)}, isErr: true},
		{new: &ChainConfig{SophonBlock: big.NewInt(3)}, isErr: true},
		{new: &ChainConfig{MoonBlock: big.NewInt(2), SophonBlock: big.NewInt(2)}, isErr: true},
	}
