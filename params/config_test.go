...
func TestCheckConfigForkOrder(t *testing.T) {
	...
	tests := []test{
		...
		{new: TestChainConfig},
		{new: &ChainConfig{TigerBlock: big.NewInt(0)}, isErr: true},
		{new: &ChainConfig{TigerBlock: big.NewInt(1)}, isErr: true},
		{new: &ChainConfig{SophonBlock: big.NewInt(3)}, isErr: true},
		{new: &ChainConfig{TigerBlock: big.NewInt(2), SophonBlock: big.NewInt(2)}, isErr: true},
	}
